...
import 'package:bloc1/data/models/masakan.dart';
import 'package:bloc1/data/models/user.dart';
  ...
  Future<Map<String, dynamic>> getRandomData() async {
    ...
    return {
      ...
      "data": DataHomeModel(
        ...
        masakan: "${dataRandomUser.firstName}",
        gambarMasakan: "${dataRandomUser.avatar}",
        porsi: "${dataRandomUser.lastName}",
        kesulitan: "${dataRandomUser.email}",
